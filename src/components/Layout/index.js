...
const Layout = ({ childern }) => {
  const xValues = ['T2', 'T3', 'T4', 'T5', 'T6', 'T7', 'CN'];
  const yValues = [5, 7.5, 4.2, 2.1, 5.4, 9.6, 4.2, 1.7];
  const barColors = [
    "#4AB584",
    "#4AB584",
    "#4AB584",
  ...
  const xDoughnut = ['Cần hoàn thành', 'Đã hoàn thành', 'Quá hạn'];
  const yDoughnut = [20, 70, 10];
  ...
  return (
    <>
      <Sider/>
      {<Header title={"Header"}/>}
      <div style={{marginLeft: "13%", paddingTop: "100px"}}>
          ...
          <div className="container-main">
            <div className="inner-list">
              <div className="inner-row">
                <div className="inner-item" graph>
                ...
                <div className="inner-item" Doughnut>
